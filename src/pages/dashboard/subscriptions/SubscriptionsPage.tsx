...
export default function SubscriptionsPage() {
  ...
  const fetchSubscriptionTypes = async () => {
    try {
      ...
      const received: SubscriptionType[] = (data?.data ?? []).filter((t: any) =>
        ["weekly", "monthly", "3months"].includes(t?.name)
      ...
      toast({
        title: "Error",
        description: "Couldn't load subscription types.",
        variant: "destructive",
      })
    } finally {
  ...
  return (
    <div className="flex flex-col">
      <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
        ...
        {/* Subscription Types (Admin-configurable) */}
        <Card>
          ...
          <CardContent>
            <Table>
              ...
              <TableBody>
                ...
                {typesLoading && (
                  <TableRow>
                    <TableCell colSpan={2} className="text-muted-foreground">Loading types...</TableCell>
                  </TableRow>
                )}
              </TableBody>
            </Table>
